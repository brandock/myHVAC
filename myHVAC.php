...
<nav id="buttons" class="d-flex justify-content-between">
    <?php include(dirname(__DIR__).'/OpenEnergyMonitor/config-nav.php'); ?>
</nav>
...
<section id="app-block" style="display:none" class="block">
	...
	<!--Brandon: pull in the graph navigator buttons. I had to add the /OpenEnergyMonitor portion of the path--> 
...
<div id="app-setup" style="display:none; padding-top:50px" class="block">
    <h2 class="appconfig-title">MyHVAC</h2>
    <div class="appconfig-description">
        <div class="appconfig-description-inner">
            Examine heating, cooling, and dual-zone dampers.
...
config.app = {
	...
	"damper1":{"type":"feed", "autoname":"damper1", "engine":"5", "description":"Main Level Zone Dampler Feed"},
	"damper2":{"type":"feed", "autoname":"damper12", "engine":"5", "description":"Upstairs Zone Dampler Feed"},	
